...
/// Gets the subminute nanoseconds from nanoseconds
...
/// Gets the subseconds nanoseconds from nanoseconds
pub(crate) fn nanos_to_subsecond_nanos(nanoseconds: u64) -> i64 {
    (nanoseconds % NANOS_PER_SEC) as i64
}

/// Converts days and nanoseconds to milliseconds
...
/// Gets the submillisecond nanoseconds from nanoseconds
pub(crate) fn nanos_to_submilli_nanos(nanoseconds: u64) -> i64 {
    (nanoseconds % 1_000_000) as i64
}

/// Converts days and nanoseconds to microseconds
...
/// Gets the submicrosecond nanoseconds from nanoseconds
